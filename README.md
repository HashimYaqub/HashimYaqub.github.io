...
### 🚀 About Me
Innovative software engineer with 11+ years of experience building VR/AR/MR applications in Unity3D. Skilled in technical leadership, gameplay systems, and immersive interaction design. Passionate about applying game design principles to training, simulation, and entertainment. Published researcher in VR Human-Computer Interaction with a proven track record of delivering cross-platform experiences.
...
- **Eye Tracking** (Research and implementation)
- **Point Cloud Processing**
- **iOS and Android AR Applications**

#### Development Tools & Practices
- **Git & Advanced GitHub Processes** (LinkedIn Certified)
- **DevOps & CI/CD Pipelines** (LinkedIn Certified)
- **Docker** and containerization
- **Git Actions** automation
- **Unity Input System** & **Unity UI Toolkit**
- **Agile Development** (JIRA, Confluence, Linear)
...
### 📜 Certifications
- **Advanced GitHub Processes** - LinkedIn Learning (2025)
- **DevOps Training** - LinkedIn Learning (2025)

---

### 🏆 Achievements & Conference Participation
- **Published Researcher** in VR Human-Computer Interaction
- **Conference Participation**: IEEE VR, CHI, SIGGRAPH, Eurographics
- **Public Demonstrations**: Cheltenham Science Festival, EGX Rezzed, Brighton Develop Conference
...
### 📬 Let's Connect!
I'm always interested in discussing VR/AR projects, technical leadership opportunities, or innovative applications of immersive technology in training and simulation.
...
*Specializing in VR/AR/MR • Unity3D Expert • Technical Leadership • Research-Driven Development*
